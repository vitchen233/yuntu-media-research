...
RedFox还提供抖音广域关键词作品搜索、每日热门榜、每日点赞飙升榜、七日点赞飙升榜、账号作品、作品详情和视频提文案。2026-08-30实测`search_works_wide`能返回近3天作品及发布时间、点赞、评论、收藏、分享和作品链接，因此热点发现默认优先广域库；优质库负责补充账号基线和历史字段。

广域库关键词搜索可能采用宽匹配，必须运行相关性过滤。优质库组合词空结果只能说明该库当前未收录，不能推断平台没有相关内容。若3天无样本，按“拆组合词→扩到7天”的顺序回退并留痕。
